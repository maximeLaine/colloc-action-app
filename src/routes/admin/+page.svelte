...
<div class="container console">
	...
	<div class="console-body">
		...
		<section class="panel panel-right">
			<h2 class="panel-title">🗂 Gestion</h2>
...
<style>
	...
	/* Layout */
	.console-body { display: grid; grid-template-columns: 1fr 300px; gap: 1.5rem; }
	...
	/* Section links */
	.section-links { display: flex; flex-direction: column; gap: 0.5rem; }
	.section-link { display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem 1rem; text-decoration: none; transition: border-color 0.2s; }
	.section-link:hover { border-color: rgba(194,55,74,0.5); }
	.section-icon { font-size: 1.1rem; flex-shrink: 0; }
	.section-info { flex: 1; }
	.section-label { font-family: 'Cinzel', serif; font-size: 0.75rem; font-weight: 700; letter-spacing: 0.06em; text-transform: uppercase; color: #FFF; }
	.section-desc { font-size: 0.72rem; color: rgba(240,237,234,0.35); margin-top: 0.1rem; }
	.section-arrow { color: rgba(240,237,234,0.2); font-size: 0.9rem; }
